...
const firstNumber = showArrayElement(numbers, 0);
...
function replaceFirstElement(array, newElement) {
  array.shift();
  array.unshift(newElement);
  return array;
}

replaceFirstElement(fruits, "mango");
console.log(fruits);
...
function accessThirdLevelArray(array, indexOne, indexTwo, indexThree) {
  return (nestedNumber = array[indexOne][indexTwo][indexThree]);
}
accessThirdLevelArray(nestedNumbers, 1, 2, 0);
